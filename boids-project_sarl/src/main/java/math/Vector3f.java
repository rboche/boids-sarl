...
public class Vector3f extends Tuple3f implements java.io.Serializable {
 ...
 /**
  ...
  /**
    ...
    *
    * @param Vector3f vect : vecteur a additionner
    *
    * */
   public void plus(Vector3f vect){
	   x += vect.x;
	   y += vect.y;
	   z += vect.z;
   }
    ...
    *
    * @param Vector3f vect : vecteur à soustraire
    * */
   public void moins(Vector3f vect){
	   x -= vect.x;
	   y -= vect.y;
	   z -= vect.z;
   }
   ...
   public double point(Vector3f vect){
